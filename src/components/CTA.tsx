function CTA() {
  ...
  return (
    <section id="kontakt" className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 via-blue-600 to-blue-700 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <a
            ...
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-blue-600 bg-white rounded-xl hover:bg-blue-50 transition-all shadow-xl hover:shadow-2xl hover:scale-105"
          >
            Book Gratis Demo
          </a>
        </div>
