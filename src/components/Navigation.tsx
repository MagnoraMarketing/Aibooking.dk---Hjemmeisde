...
function Navigation({ onNavigate }: NavigationProps) {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-xl z-50 border-b border-slate-200/50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-3">
              <div className="w-11 h-11 bg-gradient-to-br from-blue-600 via-blue-600 to-blue-700 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/20">
                <Phone className="w-6 h-6 text-white" />
              </div>
              <span className="text-2xl font-bold text-slate-900 tracking-tight">Aibooking.dk</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button
                ...
                className="text-slate-600 hover:text-blue-600 transition-all font-medium text-[15px]"
              >
              ...
              <a href="#priser" className="text-slate-600 hover:text-blue-600 transition-all font-medium text-[15px]">
                {i18n.language === 'da' ? 'Priser' : 'Pricing'}
              </a>
              <div className="relative" ref={dropdownRef}>
                <button
                  onClick={() => setIsIndustriesOpen(!isIndustriesOpen)}
                  className="flex items-center space-x-2 text-slate-600 hover:text-blue-600 transition-all font-medium text-[15px]"
                >
                ...
                {isIndustriesOpen && (
                  <div className="absolute top-full left-0 mt-3 w-80 bg-white rounded-2xl shadow-xl border border-slate-200/60 py-2 z-50">
                    {industries.map((industry, index) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full flex items-start space-x-4 px-5 py-3.5 hover:bg-slate-50/80 transition-all text-left"
                        >
                          ...
                          <div>
                            <div className="text-slate-900 font-semibold mb-0.5 text-[15px]">{industry.name}</div>
              ...
              <div className="relative" ref={contactDropdownRef}>
                ...
                {isContactOpen && (
                  <div className="absolute top-full right-0 mt-3 w-56 bg-white rounded-2xl shadow-xl border border-slate-200/60 py-2 z-50">
                    <button
                      onClick={() => { onNavigate('contact'); setIsContactOpen(false); }}
                      className="w-full flex items-center space-x-3 px-5 py-3 hover:bg-slate-50/80 transition-all text-left"
                    >
              ...
              <div className="relative" ref={languageDropdownRef}>
                ...
                {isLanguageOpen && (
                  <div className="absolute top-full right-0 mt-3 w-40 bg-white rounded-2xl shadow-xl border border-slate-200/60 py-2 z-50">
                    <button
                      onClick={() => changeLanguage('da')}
                      className="w-full flex items-center space-x-3 px-5 py-3 hover:bg-slate-50/80 transition-all text-left"
                    >
                      <span className="text-slate-900 font-medium text-[15px]">🇩🇰 Dansk</span>
                    </button>
                    <button
                      onClick={() => changeLanguage('en')}
                      className="w-full flex items-center space-x-3 px-5 py-3 hover:bg-slate-50/80 transition-all text-left"
                    >
                      <span className="text-slate-900 font-medium text-[15px]">🇬🇧 English</span>
                    </button>
                  </div>
                )}
              </div>
              <a
                ...
                className="bg-blue-600 text-white px-7 py-2.5 rounded-xl hover:bg-blue-700 transition-all font-semibold shadow-sm hover:shadow-md transform hover:scale-[1.02] text-[15px] inline-block"
              >
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 h-20 border-b border-slate-100 flex-shrink-0">
          <div className="flex items-center space-x-2.5">
            ...
            <span className="text-lg font-bold text-slate-900">Aibooking.dk</span>
          </div>
          <button
            onClick={() => setIsMobileOpen(false)}
        ...
        <div className="flex-1 overflow-y-auto py-4 px-3">
          <button
            ...
            className="w-full flex items-center px-4 py-3.5 rounded-xl text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-all font-medium text-[15px] text-left"
          >
            {i18n.language === 'da' ? 'Hjem' : 'Home'}
          </button>
          <button
          ...
          <a
            href="#priser"
            onClick={() => setIsMobileOpen(false)}
            className="w-full flex items-center px-4 py-3.5 rounded-xl text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-all font-medium text-[15px]"
          >
            {i18n.language === 'da' ? 'Priser' : 'Pricing'}
          </a>
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-4 py-3.5 rounded-xl text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-all font-medium text-[15px]"
          >
          ...
          {mobileIndustriesOpen && (
            <div className="ml-3 mb-1 border-l-2 border-blue-100 pl-3 space-y-1">
              {industries.map((industry, index) => {
                const Icon = industry.icon;
                return (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-blue-50 hover:text-blue-600 transition-all text-left"
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-400">{industry.description}</div>
                    </div>
                  </button>
                );
              })}
              <button
                ...
                className="w-full px-3 py-2 text-sm text-blue-600 font-semibold hover:text-blue-700 transition-colors text-left"
              >
                {i18n.language === 'da' ? 'Se alle brancher →' : 'See all industries →'}
              </button>
            </div>
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-4 py-3.5 rounded-xl text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-all font-medium text-[15px] text-left"
          >
            <Plug className="w-4 h-4" />
          ...
          <div className="mt-2 px-4 py-3 border-t border-slate-100">
            <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Sprog</p>
            <div className="flex gap-2">
              <button
                onClick={() => { changeLanguage('da'); setIsMobileOpen(false); }}
                className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${i18n.language === 'da' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-700 hover:bg-slate-200'}`}
              >
                🇩🇰 Dansk
              </button>
              <button
                onClick={() => { changeLanguage('en'); setIsMobileOpen(false); }}
                className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${i18n.language === 'en' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-700 hover:bg-slate-200'}`}
              >
                🇬🇧 English
              </button>
            </div>
        ...
        {/* Drawer footer CTA */}
        <div className="px-4 py-5 border-t border-slate-100 flex-shrink-0">
          <a
            href="https://cal.com/aibooking-booking/intro-voiceagent-aibooking.dk"
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => setIsMobileOpen(false)}
            className="w-full flex items-center justify-center bg-blue-600 text-white py-3.5 rounded-xl hover:bg-blue-700 transition-all font-semibold text-[15px] shadow-md"
          >
            {i18n.language === 'da' ? 'Book Demo' : 'Book Demo'}
          </a>
        </div>
