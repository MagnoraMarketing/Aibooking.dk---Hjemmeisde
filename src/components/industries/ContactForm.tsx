    ...
    <div className="bg-gradient-to-br from-slate-50 to-blue-50 py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-slate-500 mt-4">Eller udfyld formularen nedenfor, så kontakter vi dig</p>
        </div>
          ...
          {submitted ? (
            ...
            <>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white py-4 rounded-xl hover:from-blue-700 hover:to-blue-600 transition-all font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
