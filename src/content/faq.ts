...
export const contactFAQs: FAQItem[] = [
  {
    ...
    answer_da: 'Send en email, eller udfyld kontaktformularen på siden, så vender vi tilbage inden for 24 timer.',
    answer_en: 'Send an email or fill in the contact form on the page, and we\'ll get back to you within 24 hours.',
    ...
    answer_pt: 'Envie um email, ou preencha o formulário de contacto na página, e responderemos no prazo de 24 horas.',
    answer_fr: 'Envoyez un e-mail ou remplissez le formulaire de contact sur la page, et nous vous répondrons sous 24 heures.',
    answer_es: 'Envía un correo electrónico o rellena el formulario de contacto en la página, y te responderemos en un plazo de 24 horas.',
  },
  {
