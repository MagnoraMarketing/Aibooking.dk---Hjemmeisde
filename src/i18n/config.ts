...
import widgetCapabilitiesSEODa from './locales/shared/widgetCapabilitiesSEO.da.json';
import widgetCapabilitiesSEOEn from './locales/shared/widgetCapabilitiesSEO.en.json';
