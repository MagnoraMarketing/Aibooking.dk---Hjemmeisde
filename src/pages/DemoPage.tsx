        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-ink-600 max-w-3xl mx-auto leading-relaxed">
              ...
              Book en gratis og uforpligtende demo i dag og få <span className="font-bold text-brand-600">7 dages gratis prøveperiode</span> med fuld adgang.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-ink-200">
              <div className="w-12 h-12 bg-brand-100 rounded-xl flex items-center justify-center mb-4">
                <Calendar className="w-6 h-6 text-brand-600" />
              </div>
              <h3 className="text-xl font-bold text-ink-900 mb-2">Gratis Gennemgang</h3>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-ink-200">
              ...
              <h3 className="text-xl font-bold text-ink-900 mb-2">7 Dages Gratis Demo</h3>
              <p className="text-ink-600">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-ink-200">
              ...
              <h3 className="text-xl font-bold text-ink-900 mb-2">Vi Hjælper Dig I Gang</h3>
              <p className="text-ink-600">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl shadow-2xl border border-ink-200 overflow-hidden">
            <div className="bg-gradient-to-r from-brand-600 to-brand-700 p-8 text-center">
              ...
              <p className="text-brand-100">Book et møde der passer til din kalender</p>
            </div>
          ...
          <div className="mt-12 bg-ink-50 rounded-2xl p-8 border border-ink-200">
            <h3 className="text-2xl font-bold text-ink-900 mb-4 text-center">Hvad Sker Der Efter Booking?</h3>
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-ink-900 mb-2">Book Møde</h4>
                <p className="text-sm text-ink-600">Vælg en tid der passer dig</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-600 text-white rounded-full flex items-center justify-center mx-auto mb-3 font-bold text-lg">
                  2
                </div>
                <h4 className="font-semibold text-ink-900 mb-2">Personlig Demo</h4>
                <p className="text-sm text-ink-600">Se AI-receptionisten i aktion</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-600 text-white rounded-full flex items-center justify-center mx-auto mb-3 font-bold text-lg">
                  3
                </div>
                <h4 className="font-semibold text-ink-900 mb-2">Gratis Aktivering</h4>
                <p className="text-sm text-ink-600">Få 7 dages fuld adgang</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-600 text-white rounded-full flex items-center justify-center mx-auto mb-3 font-bold text-lg">
                  4
                </div>
                <h4 className="font-semibold text-ink-900 mb-2">Nyd Fordelene</h4>
                <p className="text-sm text-ink-600">Fokuser på at vokse din klinik</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-gradient-to-br from-brand-50 to-white p-8 rounded-3xl border border-brand-100 hover:shadow-xl transition-all">
              ...
              <h3 className="text-2xl font-bold text-ink-900 mb-4">24/7 Tilgængelighed</h3>
            ...
            <div className="bg-gradient-to-br from-green-50 to-white p-8 rounded-3xl border border-green-100 hover:shadow-xl transition-all">
              ...
              <h3 className="text-2xl font-bold text-ink-900 mb-4">Øget Effektivitet</h3>
              <p className="text-ink-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-white p-8 rounded-3xl border border-orange-100 hover:shadow-xl transition-all">
              ...
              <h3 className="text-2xl font-bold text-ink-900 mb-4">Øjeblikkelig Respons</h3>
              <p className="text-ink-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-brand-50 to-white p-8 rounded-3xl border border-brand-100 hover:shadow-xl transition-all">
              ...
              <h3 className="text-2xl font-bold text-ink-900 mb-4">Smart Kalenderintegration</h3>
              <p className="text-ink-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-red-50 to-white p-8 rounded-3xl border border-red-100 hover:shadow-xl transition-all">
              ...
              <h3 className="text-2xl font-bold text-ink-900 mb-4">Reducér No-Shows</h3>
              <p className="text-ink-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-white p-8 rounded-3xl border border-teal-100 hover:shadow-xl transition-all">
              ...
              <h3 className="text-2xl font-bold text-ink-900 mb-4">Perfekt Dansk</h3>
              <p className="text-ink-600 leading-relaxed">
      ...
      <section className="py-16 bg-gradient-to-br from-ink-50 to-brand-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-ink-200 hover:shadow-lg transition-all">
              <h3 className="text-lg font-bold text-ink-900 mb-2">Sundhedssektoren</h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-ink-200 hover:shadow-lg transition-all">
              <h3 className="text-lg font-bold text-ink-900 mb-2">Skønhed & Wellness</h3>
              <p className="text-sm text-ink-600">
            ...
            <div className="bg-white p-6 rounded-2xl border border-ink-200 hover:shadow-lg transition-all">
              <h3 className="text-lg font-bold text-ink-900 mb-2">Håndværk & Service</h3>
              <p className="text-sm text-ink-600">
            ...
            <div className="bg-white p-6 rounded-2xl border border-ink-200 hover:shadow-lg transition-all">
              <h3 className="text-lg font-bold text-ink-900 mb-2">Rådgivning & Coaching</h3>
              <p className="text-sm text-ink-600">
