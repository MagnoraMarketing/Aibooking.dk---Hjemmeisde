      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-purple-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg border border-slate-200 mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">AI-drevet kundeservice der aldrig sover</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">24/7 kundeservice</h3>
                  <p className="text-slate-600">Besvar henvendelser øjeblikkeligt uden ekstra personale</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Automatiske svar</h3>
                  <p className="text-slate-600">Håndter spørgsmål om produkter, ordrestatus og returneringer</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">SMS-opdateringer</h3>
                  <p className="text-slate-600">Automatiske notifikationer om forsendelser og leveringer</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Lynhurtige svartider</h3>
                  <p className="text-slate-600">Reducer svartider fra timer til sekunder</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Indsigt i trends</h3>
                  <p className="text-slate-600">Dashboard med kundeinteraktioner og hyppige spørgsmål</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Webshop-integration</h3>
                  <p className="text-slate-600">Integration med dit webshop-system og ordrehåndtering</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-16">
            <div className="bg-gradient-to-br from-purple-50 to-white p-8 rounded-3xl text-center border border-purple-100">
              <Clock className="w-10 h-10 text-purple-600 mx-auto mb-4" />
              <div className="text-4xl font-bold text-slate-900 mb-2">95%</div>
              <div className="text-slate-600 font-semibold">Hurtigere svar</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white p-8 rounded-3xl text-center border border-purple-100">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-2">1200+</div>
              <div className="text-slate-600 font-semibold">Henvendelser/md</div>
            </div>

            <div className="bg-gradient-to-br from-purple-50 to-white p-8 rounded-3xl text-center border border-purple-100">
              <CheckSquare className="w-10 h-10 text-purple-600 mx-auto mb-4" />
              <div className="text-4xl font-bold text-slate-900 mb-2">+28%</div>
              <div className="text-slate-600 font-semibold">Konvertering</div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-900 to-purple-900 rounded-3xl p-12 text-white text-center">
            ...
            <a
              ...
              className="bg-white text-purple-900 px-10 py-5 rounded-2xl font-bold text-xl hover:bg-purple-50 transition-all shadow-2xl inline-block"
            >
      ...
      <section className="py-20 bg-gradient-to-br from-purple-900 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white text-purple-900 px-12 py-6 rounded-2xl font-bold text-xl hover:bg-purple-50 transition-all shadow-2xl inline-block"
          >
            Book et uforpligtende møde og få et gratis test login
          </a>
        </div>
