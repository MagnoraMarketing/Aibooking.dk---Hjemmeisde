        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-10">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">Vi indsamler følgende kategorier af personlige data:</p>
            ...
            <section className="mb-10">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">Vi bruger dine personlige data til følgende formål:</p>
              <ul className="list-disc pl-6 text-slate-700 space-y-2">
            ...
            <section className="mb-10">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">I henhold til GDPR har du følgende rettigheder vedrørende dine personlige data:</p>
              <ul className="list-disc pl-6 text-slate-700 space-y-2">
            ...
            <section className="mb-10">
              ...
              <p className="text-slate-700 leading-relaxed">
                Hvis du har spørgsmål om denne privatlivspolitik eller ønsker at udøve dine rettigheder, er du velkommen til at kontakte os på <a href="mailto:kontakt@aibooking.dk" className="text-blue-600 hover:text-blue-800">kontakt@aibooking.dk</a>.
              </p>
            </section>
          </div>
        </div>
